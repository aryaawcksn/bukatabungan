...
export default function FormSimpel({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      {/* Data Pribadi */}
      <div>
        <h3 className="text-emerald-900 mb-6 text-2xl">Data Pribadi (Pelajar)</h3>
        <div className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            {/* Status Pernikahan - Usually Belum Menikah for Simpel but keep it */}
            {/* <div>
      ...
      {/* Informasi Sekolah (Simpel Specific) */}
      <div className="space-y-5 mt-5">
        <h3 className="text-emerald-900 mb-6 text-2xl">Informasi Sekolah</h3>

        {/* Nama Sekolah (Mapped to tempatBekerja) */}
        <div>
        ...
        {/* Alamat Sekolah (Mapped to alamatKantor) */}
        <div>
        ...
        {/* Sumber Dana & Tujuan (Simplified or kept) */}
      ...
      <div className="mb-4">
        ...
        {!ktpFile && !ktpPreview ? (
          <Upload
            label="Upload Foto KTP / Kartu Pelajar"
      ...
      <div className="mb-4">
        ...
        {!selfieFile && !selfiePreview ? (
          <Upload
            label="Upload Selfie dengan KTP / Kartu Pelajar"
            description="Format: JPG, PNG (Max. 2MB)"
            onChange={(file) => {
              setSelfieFile(file);
